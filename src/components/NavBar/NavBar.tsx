...
const NavBar = () => {
  ...
  return (
    <nav className={cn(
      "absolute top-0 py-6 left-0 px-[100px] bg-[#F3F3F3] backdrop-blur-[14px] transition-all duration-500 ease-in-out -translate-y-full w-full flex items-center justify-between",
